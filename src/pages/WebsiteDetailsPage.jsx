...
const WebsiteDetailsPage = () => {
  ...
  const deleteProject = () => {
    axios.delete(`${API_URL}/websites/${websiteId}`).then((response) => {
      navigate("/");
    });
  };
            ...
            <div className="browser-nav">
              ...
              <div className="url-bar">
                ...
                >
                  <input
                    type="text"
                    defaultValue={selectedWebsite.url}
          ...
          <div className="text-white w-[800px] flex items-center justify-between">
            ...
            <div className=" flex justify-end items-center gap-8 w-[250px] h-auto">
              <NavLink to={`/websites/edit/${websiteId}`}>
                <button className="bg-gray-700 text-blue-50 rounded-full w-12 h-12 hover:scale-110 transition-transform flex items-center justify-center">
                  <img src="/page-edit.svg" alt="edit-button" />
                </button>
              </NavLink>

              <button
                className="bg-yellow-600 text-blue-50 rounded-full w-12 h-12 hover:scale-110 transition-transform"
