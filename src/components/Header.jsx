const Header = () => {
  ...
  return (
      <>
        <span className="fixed left-[20px] top-[24px] text-[62px] text-justify text-white leading-tight z-20 mix-blend-difference">IronExpo</span>,
        <p className="text-[62px] indent-[270px] text-justify text-white mb-5 mx-5 leading-tight">
