const Header = () => {
  ...
  return (
      <>
        <span className="fixed left-[20px] top-[24px] text-[62px] text-justify text-gray-50 leading-tight z-30 mix-blend-difference text-shadow">IronExpo</span>,
        <p className="text-[62px] indent-[270px] text-justify text-gray-300 mb-5 mx-5 leading-tight text-shadow z-20">
